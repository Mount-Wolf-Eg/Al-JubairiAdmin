<template>
  <div class="users-page">
    ...
    <AddServices @resetItem="item = {}" :itemData="item"></AddServices>
    <ServicesTable @editItem="edit($event)"></ServicesTable>
  </div>
</template>
...
const item = ref({});
const selectore = ref("addService");
