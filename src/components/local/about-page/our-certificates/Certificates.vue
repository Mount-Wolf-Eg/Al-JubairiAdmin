<template>
  <div class="users-page">
    ...
    <AddCertificates @resetItem="item = {}" :itemData="item"></AddCertificates>
    <CertificateTable @editItem="edit($event)"></CertificateTable>
  </div>
</template>
...
const item = ref({});
const selectore = ref("addCertificateAbout");
